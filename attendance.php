...
<html lang="en">
    ...
    <nav class="navbar navbar-dark bg-dark">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a href="attendance.php" class="nav-link active">Ver Registros</a>
            </li>
            <li class="nav-item">
                <a href="users.php" class="nav-link">Ver Usuarios</a>
            </li>
        </ul>
    </nav>
    <div class="container">
                    ...
                    foreach($users as $user) {
                        ...
                        for ( $iter = 1; $iter <= $num_days; $iter++) {
                            ...
                            if(!empty($attendance)) {
                                ...
                                echo '<td class="table-secondary">No hay datos</td>';
                            }
                        }
                        echo '</tr>';
                    }
